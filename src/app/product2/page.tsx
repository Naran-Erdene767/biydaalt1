...
const Home = () => {
    ...
    const sizes = ["6 x 8 inch", "7 x 9 inch", "8 x 11 inch", "9 x 12 inch", "10 x 15 inch", "12 x 16 inch"];
    const product = products[15];
        ...
        <div className="bg-gray-100 text-black selection:bg-teal-300 dark:bg-neutral-900 dark:text-white dark:selection:bg-pink-500 min-h-screen relative">
            ...
            <div className="flex flex-col m-10 md:flex-row gap-10 p-6 max-w-[1400px] mx-auto bg-white shadow-lg rounded-xl">
                ...
                <div className="flex flex-col gap-6 w-full md:w-1/2">
                    ...
                    <p className="text-gray-600">Strong 210D ripstop nylon drawstring bag</p>
                    <p className="text-gray-600">Available in multiple sizes</p>
                    <p className="text-gray-600">Easy-to-close durable drawstring</p>
                    <p className="text-gray-600">Sturdy, reusable, and resilient</p>
                    <button
